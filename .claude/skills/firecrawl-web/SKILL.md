...
```bash
python .claude/skills/firecrawl-web/fc.py markdown "https://example.com" --main-only
```
...
```bash
python .claude/skills/firecrawl-web/fc.py screenshot "https://example.com" -o page.png
```
...
```bash
python .claude/skills/firecrawl-web/fc.py extract "https://example.com/product" --schema schema.json
```

Add a prompt for better accuracy:

```bash
python .claude/skills/firecrawl-web/fc.py extract "https://example.com/product" --schema schema.json --prompt "Extract the main product details"
```
...
```bash
python .claude/skills/firecrawl-web/fc.py search "Python 3.13 new features"
```

Limit results:

```bash
python .claude/skills/firecrawl-web/fc.py search "latest React documentation" --limit 3
```
...
```bash
python .claude/skills/firecrawl-web/fc.py crawl "https://docs.newframework.dev" --limit 30
```

Save pages to a directory:

```bash
python .claude/skills/firecrawl-web/fc.py crawl "https://docs.example.com" --limit 50 --output ./docs
```
