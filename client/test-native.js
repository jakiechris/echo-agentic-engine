 ...
 * 使用Node.js原生fetch + AbortController保持连接
 */
...
console.log('=== 通过Engine测试 (Node.js原生fetch) ===\n');
...
async function test() {
    ...
    if (sessionResponse.error) {
        console.error('创建会话失败:', sessionResponse.error);
        process.exit(1);
    }
